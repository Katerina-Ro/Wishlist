...
public class UnknownCommand implements CommandEditSendMessage {
 ...
 /*
    ...
    public SendMessage execute(Update update) {
        return SendMessageUtils.sendMessage(update, MESSAGE_UNKNOWNCOMMAND, false);
    }*/


    @Override
    public EditMessageText execute(Update update) {
        return SendMessageUtils.sendEditMessage (update, MESSAGE_UNKNOWNCOMMAND, Buttons.getKeyBoardStartMenu());
    }
}
