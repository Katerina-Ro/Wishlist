...
public interface GiftRepository {
     ...
     */
    void createGift (String name, String nameGift, long chat_id, String webLink, String comment, String giftStatus) throws SQLException;
     ...
     * @throws SQLException - если нет соединения с БД, то будет выброшено исключение
     */
    void updateStatusGift (long chat_idPresenter, int idGift, long chat_idGigtOwner) throws SQLException;
     ...
     * @throws SQLException - если нет соединения с БД, то будет выброшено исключение
     */
    void getInfoGift (long chat_id) throws SQLException;
